...
CConVar::CConVar(const char *asName, const char *asDefValue, int anFlags, const char *asDesc)
{
	mpData = malloc(sizeof(cvar_t));
	memset(mpData, 0, sizeof(cvar_t);
...
const char *CConVar::GetDefValue() const
{
	return msDefValue;
};
